 ...
 * 
 * @b NOTA: Esta clase esta obsoleta, no la use, proximamente sera eliminada del proyecto!!!, en su lugar use KLDatabase
 * 
 * @author David Cuadrado
 */
 
class BDConnection : public QObject
{
	private:
		QSqlDatabase *cnx;
	...
	public:
		...
		QSqlDatabase *getDB(const QString &key, bool open = false) const;
		bool openConnection();
