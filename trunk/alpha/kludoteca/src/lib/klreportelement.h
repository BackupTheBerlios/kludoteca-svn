...
class KLReportElement : public QObject
{
	public:
		enum { INVALID = -1 };
		...
		KLReportElement(double value = INVALID, QColor valueColor = Qt::gray,int valuePattern = Qt::SolidPattern,const QString& label = QString::null,QColor labelColor = Qt::black);
		~KLReportElement() {}
