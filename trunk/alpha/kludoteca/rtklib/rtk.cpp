 ...
 * rtk.cpp This file includes all the RTK functionality
 * 
...
<STYLE name="integer"  mask="000000" halignment="right"/>
\endverbatim   
...
\verbatim   
<INPUT name="default" driver="csv" filename="/etc/passwd" delimiters=":" quote="" headerlines="0">
    <INPUTFIELD name="user" source="0" type="text"></INPUTFIELD>
    <INPUTFIELD name="uid" source="2" type="integer"></INPUTFIELD>
    <INPUTFIELD name="gid" source="3" type="integer"></INPUTFIELD>
    <INPUTFIELD name="realname" source="4" type="text"></INPUTFIELD>
    <INPUTFIELD name="homedir" source="5" type="text"></INPUTFIELD>
    <INPUTFIELD name="shell" source="6" type="text"></INPUTFIELD>
</INPUT>
\endverbatim   
...
<SECTION name="details" type="details" level="1" style="details" sizey="1" sizex="80">
    ...
    <OBJECT name="gid" 
      ...
      value="input.gid" mask="00000"
      ></OBJECT>
    <OBJECT name="realname"
      posx="32" posy="0" sizex="7" sizey="1" 
	  adjustment="grow" textcolor="red"
...
\verbatim	
	...
	rtkview --format openoffice --oo-template-dir=/path/to/openoffice/template/document --output users.sxc passwd.rtk
\endverbatim	
